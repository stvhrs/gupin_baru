            ...
            child: SingleChildScrollView(
              child: Column(
                  ...
                  children: [
                        ...
                        children: [
                            ...
                            child: InkWell(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => ListTo(
                                        widget.color, true, widget.judul)));
                              },
                              child: Row(
                                children: [
                                  Padding(
                          ...
                          InkWell(
                              onTap: () {
                                Navigator.of(context).push(MaterialPageRoute(
                                    builder: (context) => ListTo(
                                        widget.color, false, widget.judul)));
                              },
                              child: Container(
                                padding: EdgeInsets.only(
                                    top: 8, bottom: 8, left: 8, right: 8),
                    ...
                    FutureBuilder(
                        future: ApiService().getMapelDetail(widget.idMapel),
